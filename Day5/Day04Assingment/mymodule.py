...
# this is my module having four function's 
...
def return_Imp_msg(preferance):
    if preferance=="yes":
        print('''Keep exploring, keep asking questions, and keep building. Every task you complete is a step toward real industry experience. Stay curious and take your internship as an opportunity to grow.''')
    else:
